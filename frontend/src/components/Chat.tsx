...
export default function Chat({ roomId }: { roomId: string }) {
  ...
  return (
    <div className="relative min-h-[70vh] bg-gray-900 px-4 pt-4 md:w-[20%] hidden md:flex flex-col rounded-md m-3 h-full">
      <div className="h-full w-full">
        ...
        <form className="absolute bottom-4 inset-x-3" onSubmit={(e) => sendMessage(e)}>
          <div className="flex relative ">
            <input type="text" ref={currentMsg} className="px-3 py-2 bg-gray-950 rounded-md w-full" />
            <button type="submit">
