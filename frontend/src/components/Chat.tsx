            ...
            <div className="relative h-full w-full">
                ...
                <form action="" className="absolute bottom-2 w-full">
                    <div className="flex relative">
                        <input type="text" className="px-3 py-2 bg-gray-950 rounded-md w-full" />
                        <Image className="absolute right-2 top-2.5" src="/send.png" width={20} height={20} alt="send" />
                    </div>
                </form>
            </div>
        </div>
